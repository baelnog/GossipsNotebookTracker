...
namespace ChecklistTracker.View
{
    ...
    /// Forked from: https://github.com/CommunityToolkit/WindowsCommunityToolkit/blob/winui-7.1.2/CommunityToolkit.WinUI.UI.Controls.Primitives/StaggeredPanel/StaggeredPanel.cs
    /// </summary>
    public class StaggeredPanel : Panel
    {
        ...
        protected override Size ArrangeOverride(Size finalSize)
        {
            ...
            double totalWidth = _columnWidth + ((numColumns - 1) * (_columnWidth + ColumnSpacing));
            if (totalWidth > finalSize.Width && numColumns > 1)
            {
                numColumns--;
            ...
            for (int i = 0; i < Children.Count; i++)
            {
                ...
                Rect bounds = new Rect((float)itemHorizontalOffset, (float)itemVerticalOffset, (float)_columnWidth, (float)elementHeight);
