...
namespace ChecklistTracker
{
    ...
    public sealed partial class MainWindow : Window
    {
        ...
        private void SetupMenus()
        {
            ...
            {
                var oldItems = ScreenCaptureList.Items.ToList();
                ...
                {
                    if (!DisplayHardwareMapper.TryGetDeviceString(display.DeviceName, out var deviceString))
                    {
                        deviceString = display.DeviceName;
                    }
                    var item = new RadioMenuFlyoutItem
                    {
                        Text = deviceString,
                    ...
                    ScreenCaptureList.Items.Add(item);
                }
            }
            // Initial population
